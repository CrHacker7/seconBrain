...
- .tar.gz o .tgz: tar -xvzf archivo.tar.gz
...
- .7z: 7z x archivo.7z
	...
	./nombre_del_archivo // para ejecutar si termina en [.sh]
	chmod +x nombre_del_archivo //si no tiene permisos de ejecución:
	
	◘◘◘◘◘ EJECUTAR ARCHIVOS .DEB
	sudo dpkg -i nombre_del_archivo.deb
	sudo apt-get install -f (SI PROBLEMAS DE DEPENDENCIAS)
	RESUELVE AUTOMATICAMENTE LAS DEPENDENCIAS
	sudo apt install ./docker-desktop-amd64.deb

#####DESCARGAR SNAPD EN LINUX MINT
